...
<body>
        ...
        <header class="bg-light py-3">
                ...
                <div class="d-flex justify-content-between align-items-center flex-column flex-sm-row gap-3">
                    ...
                    <form action="#" class="flex-fill">
                        <div class="input-group position-relative mb-0 w-100">
                            <input type="text" class="form-control rounded-0 mb-0 border border-primary border-end-0" placeholder="Search for category...."
                                aria-label="Search" aria-describedby="button-addon2" data-bs-toggle="modal"
                                data-bs-target="#category-search-pop-up">
                            <button class="z-3 btn btn-outline-primary ms-auto"  data-bs-toggle="modal"
                                data-bs-target="#category-search-pop-up" type="button"
            ...
            <nav class="container-fluid position-relative">
                <ul class="d-none justify-content-center align-items-center list-unstyled mb-0">
                    <li class="dropdown">
                        <a href="#" class="px-3 py-2 text-decoration-none menu-link shop-category">Shop <i class="fa-solid fa-angle-down"></i></a>
                ...
                <div class="small-12 large-12 medium-12 cell">
                  <div class="align-center top-bar bg-light">
                    ...
                    <nav id="responsive-menu">
                      <ul class="menu vertical large-horizontal dropdown bg-light" data-responsive-menu="accordion medium-dropdown"
                        role="menubar" data-dropdown-menu="4gg5js-dropdown-menu" data-disable-hover="true">
                        <li role="menuitem"
                          >
    ...
    <div class="modal fade bg-white" id="category-search-pop-up" tabindex="-1" aria-labelledby="category-search-pop-up-label" aria-modal="true"
    role="dialog">
        <div class="p-1">
    ...
    <main>
        ...
        <div class="owl-carousel" id="home-banner">
            ...
            <div>
                <img src="{{ asset('assets/images/home-banner/vegetable-oil-banner.png') }}" class="home-banner-image d-none d-md-block" alt="oil-banner">
                <img src="{{ asset('assets/images/home-banner/mobile-vegetable-oil-banner.png') }}" class="home-banner-image d-block d-md-none" alt="oil-banner">
                <div class="banner-text-container">
                    <h2 class="text-primary mb-3 fw-bold fs-1"> Dream Sunshine</h2>
                    <h3 class="text-danger mb-0 fw-bold fs-2"> Low Fat Cooking Promise Of Quality</h3>
                </div>
            </div>
            <div>
              ...
              <div class="row align-items-center">
                <div class="col-lg-6">
                  <div class="hero_content_wrap">
                    ...
                    <p class="heading_description">
                        At Dreamsunshine Digital Pvt Ltd, quality is at the heart of everything we do. Since 2018, we've been committed to offering products that are reliable, well-made, and thoughtfully selected to match real-world needs.
                    </p>
                    <p class="heading_description">
                        We pay close attention to detail and believe in doing things properly. Each product goes through careful checks to ensure it meets our standards before being offered.
                    </p>
                    <p class="heading_description">
                ...
                <div class="col-lg-6">
                  <div class="hero_image_wrap">
                    <img src="{{ asset('assets/images/about/New Dreams catalogue-1.png') }}" alt="Talking Minds – Psychotherapist Site Template">
                  </div>
                </div>
              </div>
            </div>
          ...
          <section class="dram-section">
            <div class="container position-relative overflow-hidden">
                <div class="section_heading text-center">
                    <h2 class="section_heading_text">Best Offer</h2>
                    <p class="section_heading_description text-center mb-0">
                        Here are some of the best offer which you may like
                    </p>
                </div>
                <div class="owl-carousel owl-theme position-relative" id="productSectionCarousel3">
                            ...
                            <div class="product-card">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div class="position-relative card-btn-container">
                                        <a href="#" class="position-absolute btn btn-primary w-100 view-product-btn">View Product</a>
                                    </div>
                                </div>
                            </div>
                            </a>
                ...
                <div class="col-lg-6">
                  <div class="images_group_widget">
                    <ul class="unordered_list">
                      <li>
                          <img src="{{ asset('assets/images/about/dairy-product-1.png') }}" alt="Talking Minds - Psychotherapist Site Template">
                          <img src="{{ asset('assets/images/about/cooking-oil-3.png') }}" alt="Talking Minds - Psychotherapist Site Template">
                        </li>
                        <li>
                        <img src="{{ asset('assets/images/about/cooking-oil-2.png') }}" alt="Talking Minds - Psychotherapist Site Template">
                          <img src="{{ asset('assets/images/about/water-bottle.png') }}" alt="Talking Minds - Psychotherapist Site Template">
                      </li>
                    </ul>
                  </div>
                </div>
                    ...
                    <div class="accordion" id="faq_accordion">
                      <div class="accordion-item">
                        ...
                        <div id="collapse_one" class="accordion-collapse collapse show" aria-labelledby="heading_one" data-bs-parent="#faq_accordion">
                          <div class="accordion-body">
                            <p class="m-0">
                                We offer a wide variety of food products including dairy, rice, cooking oil, sugar, tea, snacks, and more. All products are sourced from trusted brands to ensure quality and freshness.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div class="accordion-item">
                        ...
                        <div id="collapse_two" class="accordion-collapse collapse" aria-labelledby="heading_two" data-bs-parent="#faq_accordion">
                          <div class="accordion-body">
                            <p class="m-0">
                                We carry a selection of organic and preservative-free items. Look for the “Organic” or “Natural” label on product listings for healthier choices.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div class="accordion-item">
                        ...
                        <div id="collapse_three" class="accordion-collapse collapse" aria-labelledby="heading_three" data-bs-parent="#faq_accordion">
                          <div class="accordion-body">
                            <p class="m-0">
                                Simply browse our products, add your desired items to the cart, and proceed to checkout. Follow the on-screen instructions to complete your order securely.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div class="accordion-item">
                        ...
                        <div id="collapse_four" class="accordion-collapse collapse" aria-labelledby="heading_four" data-bs-parent="#faq_accordion">
                          <div class="accordion-body">
                            <p class="m-0">
                                We accept major credit/debit cards, UPI, net banking, and digital wallets like Google Pay and Paytm for your convenience.
                            </p>
                          </div>
                        </div>
                      </div>
                      <div class="accordion-item">
                        ...
                        <div id="collapse_five" class="accordion-collapse collapse" aria-labelledby="heading_five" data-bs-parent="#faq_accordion">
                          <div class="accordion-body">
                            <p class="m-0">
                                Orders are usually delivered within 2–5 business days, depending on your location. You’ll receive tracking details once your order is dispatched.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-6 ps-lg-5">
                        <div class="bg-white shadow p-5">
                            ...
                            <form action="">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <input type="text" name="name" id="" placeholder="First Name" class="p-2 mb-4 rounded-1 lh-base">
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="text" name="name" id="" placeholder="Last Name" class="p-2 mb-4 rounded-1 lh-base">
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="tel" name="name" id="" placeholder="Phone Number" class="p-2 mb-4 rounded-1 lh-base">
                                    </div>
                                    <div class="col-lg-6">
                                        <input type="email" name="name" id="" placeholder="Email Address" class="p-2 mb-4 rounded-1 lh-base">
                                    </div>
                                    <div class="col-12">
                                        <textarea name="" id="" placeholder="Your Message" rows="4" class="p-2 mb-4 rounded-1 lh-base"></textarea>
                                    </div>
                                </div>
            ...
            <div class="row py-4">
                <div class="col-lg-2 col-md-6 col-sm-4 mb-4">
                    <div class="footer-col-head text-danger">
                        ...
                        <ul class="list-unstyled ps-0 ms-0">
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">anaya dairy product</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">anaya rice</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">dream sun shine developers</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">dream transport</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">iram dates</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">pure and hygienic suger</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">pure cooking oil</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">real eggs</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">real-oxy</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">zhakaas jeera masala</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-8 mb-4">
                    <div class="footer-col-head text-danger">
                        ...
                        <ul class="list-unstyled ps-0 ms-0">
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">mineral water</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">Cold Drinks</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">dry fruit & iram dates</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">pure basmati rice</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">Premium quality white suger</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">Dairy Product</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white text-capitalize">Refined sunflower oil</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-2 col-md-6 col-sm-4 mb-4">
                    <div class="footer-col-head text-danger">
                        ...
                        <ul class="list-unstyled ps-0 ms-0">
                            ...
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white">Shop</a>
                            </li>
                            <li class="mb-2">
                ...
                <div class="col-lg-2 col-md-6 col-sm-8 mb-4">
                    <div class="footer-col-head text-danger">
                        ...
                        <ul class="list-unstyled ps-0 ms-0">
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white"> Term Of Service</a>
                            </li>
                            <li class="mb-2">
                                <a href="#" class="text-decoration-none text-white"> Return And Refund Policy</a>
                            </li>
                            <li class="mb-2">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-col-head text-danger">
                        ...
                        <div class="d-flex align-items-center justify-content-start gap-2 mb-3">
                            <a href="tel:+9876543210" class="text-white social-media-icon call-icon-bg"><i class="fa-solid fa-phone"></i></a>
                            <a href="mailto:" class="text-white social-media-icon mail-icon-bg"><i class="fa-regular fa-envelope"></i></a>
                        </div>
                        <h5 class="mb-3">Follow Us</h5>
                        <div class="d-flex align-items-center justify-content-start gap-2">
                            <a href="#" class="text-white social-media-icon facebook-icon-bg"><i class="fa-brands fa-facebook-f"></i></a>
                            ...
                            <a href="#" class="text-white social-media-icon instagram-icon-bg"><i class="fa-brands fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid bg-danger">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center py-2 gap-2 flex-wrap">
                ...
                <p class="mb-0 text-white">Designed and Developed by <a href="https://infinityplus1.in/" class="text-decoration-none text-white">Infinity Plus 1</a></p>
            </div>
        </div>
    </div>
        ...
        item.addEventListener("click", function () {
          ...
          menuItems.forEach((otherItem) => {
            ...
            if (otherSubmenu && otherSubmenu !== submenu) {
              otherSubmenu.classList.remove("active"); // Remove active class from other submenus
            }
          });

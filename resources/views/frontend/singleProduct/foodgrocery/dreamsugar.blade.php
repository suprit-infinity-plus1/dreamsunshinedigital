...
@section('title',' Dream Sugar | DreamSunshine Digital')
@section('extracss')
...
@section('content')
    ...
    <div class="whole-body container ">
        <div>
            <p class="mt-3">Home > Dream Sugar</p>
        </div>
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['sugar.png']; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/foodGroceryImages/sugar.png') }}"
                                xoriginal="{{ asset('assets/images/category/foodGroceryImages/sugar.png') }}" />
                        </div>
                    </div>
                    ...
                    <div class="d-none d-md-block col-md-2 col-lg-1">
                        @foreach ($images as $img)
                            <div class="col border">
                                <img src="{{ asset('assets/images/category/foodGroceryImages/' . $img) }}"
                                    data-src="{{ asset('assets/images/category/foodGroceryImages/' . $img) }}"
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Dream Sugar</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        Dream Sugar – Fine, clean crystals that blend effortlessly into your favorite drinks and recipes.
Ideal for sweetening tea, coffee, desserts, and baked goods with a smooth, consistent texture.
Packaged with care to preserve freshness and purity from kitchen to table.
A trusted everyday essential for those who enjoy just the right touch of sweetness.

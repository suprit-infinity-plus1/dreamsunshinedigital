...
@section('title','Iram Dates | dates | DreamSunshine Digital')
@section('extracss')
    ...
    <div class="whole-body container ">
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['.png']; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/iram dates/datesimage.jpg') }}"
                                xoriginal="{{ asset('assets/images/category/iram dates/datesimage.jpg') }}" />
                        </div>
                    </div>
                    ...
                    <div class="d-none d-md-block col-md-2 col-lg-1">
                        @foreach ($images as $img)
                            <div class="col border">
                                <img src="{{ asset('assets/images/category/iram dates/datesimage/' . $img) }}"
                                    data-src="{{ asset('assets/images/category/iram dates/datesimage' . $img) }}"
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Iram Dates</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Iram Dates – Naturally sweet and rich in flavor, these dates are perfect for snacking or adding
                            to your favorite dishes.
                            Soft and tender, with a delightful caramel-like taste, they offer a wholesome, energy-boosting
                            treat.
                            Sourced from premium date farms, each date is handpicked for its quality and freshness.
                            A perfect choice for health-conscious individuals or anyone looking for a nutritious, satisfying
                            snack.
                        </p>

    ...
    <div class="whole-body container ">
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['oil_pouch.png']; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/pure-cooking-oil/oil_pouch.png') }}"
                                xoriginal="{{ asset('assets/images/category/pure-cooking-oil/oil_pouch.png') }}" />
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Cooking Oil - Pouch pack</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        Cooking Oil – Pouch Pack
Light, versatile, and neatly packed in a convenient pouch for easy use and storage.
Ideal for everyday cooking, from sautéing to deep-frying, with minimal mess and easy pouring.
Designed for households that value efficiency without compromising on quality.
A practical choice for daily kitchen needs.

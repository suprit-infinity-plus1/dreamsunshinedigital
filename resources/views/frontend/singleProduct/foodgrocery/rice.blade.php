...
@section('title','Anaya Rice | DreamSunshine Digital')
@section('extracss')
...
@section('content')
    ...
    <div class="whole-body container ">
        <div>
            <p class="mt-3">Home > Anaya Rice</p>
        </div>
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['15.png', '16.png', '17.png', '18.png']; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/productImage/foodgrocery/rice/15-2.png') }}"
                                xoriginal="{{ asset('assets/images/productImage/foodgrocery/rice/15-2.png') }}" />
                        </div>
                    </div>
                    ...
                    <div class="d-none d-md-block col-md-2 col-lg-1">
                        @foreach ($images as $img)
                            <div class="col border">
                                <img src="{{ asset('assets/images/productImage/foodgrocery/rice/' . $img) }}"
                                    data-src="{{ asset('assets/images/productImage/foodgrocery/rice/' . $img) }}"
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Anaya Rice</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Anaya Premium Basmati Rice (5kg/10kg). Long-grain and aged for rich aroma and authentic taste.
                            Fluffy, non-sticky texture with 3X volume after cooking. High in fibre, low glycemic index, and
                            ideal for everyday meals or special dishes. Additional details for more description here. More
                            information on the product's origin and quality. The rice is sourced from the best farms and
                            packed with care for premium quality.
                        </p>
               ...
               <div class="product_item border rounded-2">
                    <div class="product-card">
                        <div class="product-card-img position-relative overflow-hidden">
                            <img src="{!! asset('assets/images/category/foodGroceryImages/oil-bottles.png ') !!}" alt="" />
                        ...
                        <div class="card-body text-center border-top p-3">
                            <h5 class="card-title fxsm-heading fw-bolder mt-1 mb-1">
                                <a href="{{ route("singleproduct.oil_bottle") }}" class="text-main-color">
                                    Oil Bottles
                                </a>
                            </h5>
                ...
                <div class="product_item border rounded-2">
                    <div class="product-card">
                        <div class="product-card-img position-relative overflow-hidden">
                            <img src="{!! asset('assets/images/category/iram dates/datesimage.jpg') !!}" alt="" />
                            <div class="product-badge d-flex flex-column align-items-start gap-1">
                                <span class="featured-badge rounded-1 fs-small-heading">Featured</span>
                                <!-- <span class="new-badge rounded-1 fs-small-heading">New</span> -->
                            </div>
                            <div class="card-btn-container w-100 px-3">
                                <a href="{{ route("singleproduct.dates") }}" class="btn btn-primary w-100 view-product-btn">View Product</a>
                            </div>
                        </div>
                        <div class="card-body text-center border-top p-3">
                            <h5 class="card-title fxsm-heading fw-bolder mt-1 mb-1">

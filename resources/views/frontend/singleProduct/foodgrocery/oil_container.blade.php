...
@section('title','Food & Grocery | Oil Container | DreamSunshine Digital')
@section('extracss')
...
@section('content')
    ...
    <div class="whole-body container ">
        <div>
            <p class="mt-3">Home > Oil-Container</p>
        </div>
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['oil_container.png']; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/pure-cooking-oil/oil_container.png') }}"
                                xoriginal="{{ asset('assets/images/category/pure-cooking-oil/oil_container.png') }}" />
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Cooking Oil - Tin Container</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        Packed in a durable tin for bulk use and extended shelf life.
Great for large families, restaurants, or frequent cooking needs.
Sturdy and secure packaging helps maintain oil quality over time.
An economical option for those who cook in larger quantities.
                        </p>

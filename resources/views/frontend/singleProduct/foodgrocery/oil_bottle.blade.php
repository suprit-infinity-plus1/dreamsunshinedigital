...
@section('title','Food & Grocery | Oil Bottle | DreamSunshine Digital')
@section('extracss')
...
@section('content')
    ...
    <div class="whole-body container ">
        <div>
            <p class="mt-3">Home > Oil-Bottle </p>
        </div>
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['oil_bottle.png']; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/pure-cooking-oil/oil_bottle.png') }}"
                                xoriginal="{{ asset('assets/images/category/pure-cooking-oil/oil_bottle.png') }}" />
                        </div>
                    </div>
                    ...
                    <div class="d-none d-md-block col-md-2 col-lg-1">
                        @foreach ($images as $img)
                            <div class="col border">
                                <img src="{{ asset('assets/images/category/pure-cooking-oil/' . $img) }}"
                                    data-src="{{ asset('assets/images/category/pure-cooking-oil/' . $img) }}"
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Cooking Oil - Bottle Pack</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Cooking Oil – Bottle Pack
                            Hygienically sealed in a sturdy bottle that’s easy to handle and pour.
                            Perfect for maintaining freshness and ensuring a mess-free cooking experience.
                            Suited for home kitchens or small-scale use where convenience meets quality.
                            Clean, simple, and ideal for regular use.
                        </p>

...
@section('title','Anaya Dairy | Paneer | DreamSunshine Digital')
@section('extracss')
    ...
    <div class="whole-body container ">
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['paneer.png',]; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/anaya-dairy-product/paneer/10.png') }}"
                                xoriginal="{{ asset('assets/images/category/anaya-dairy-product/paneer/10.png') }}" />
                        </div>
                    </div>
                    ...
                    <div class="d-none d-md-block col-md-2 col-lg-1">
                        @foreach ($images as $img)
                            <div class="col border">
                                <img src="{{ asset('assets/images/category/anaya-dairy-product/paneer/' . $img) }}"
                                    data-src="{{ asset('assets/images/category/anaya-dairy-product/paneer/' . $img) }}"
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Paneer</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Paneer – A fresh, soft cheese that adds a mild and creamy texture to a wide variety of dishes.
                            Perfect for curries, stir-fries, or grilling, it absorbs the flavors of spices and marinades
                            beautifully.
                            Made from high-quality milk, offering a wholesome and protein-packed option for vegetarians.
                            Ideal for daily meals, special occasions, or as a healthy snack on its own.
                        </p>

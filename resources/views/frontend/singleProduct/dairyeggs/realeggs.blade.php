...
@section('title','Real Eggs | Eggs | DreamSunshine Digital')
@section('extracss')
    ...
    <div class="whole-body container ">
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['real-eggs-2.png',]; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/real-eggs/real-eggs-2.png') }}"
                                xoriginal="{{ asset('assets/images/category/real-eggs/real-eggs-2.png') }}" />
                        </div>
                    </div>
                    ...
                    <div class="d-none d-md-block col-md-2 col-lg-1">
                        @foreach ($images as $img)
                            <div class="col border">
                                <img src="{{ asset('assets/images/category/real-eggs/' . $img) }}"
                                    data-src="{{ asset('assets/images/category/real-eggs/' . $img) }}" class="w-100 side-image"
                                    alt="">
                            </div>
                            <div class="w-100"></div>
                        @endforeach
                        ...
                        <div class="d-flex flex-nowrap overflow-auto">
                            @foreach ($images as $img)
                                <div class="col-2 border ">
                                    <img src="{{ asset('assets/images/category/real-eggs/' . $img) }}"
                                        data-src="{{ asset('assets/images/category/real-eggs/' . $img) }}"
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Eggs</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Fresh Eggs – A versatile kitchen staple, known for their smooth texture and mild flavor.
                            Perfect for boiling, frying, baking, or adding to a variety of everyday dishes.
                            Carefully handled and packed to maintain freshness and quality.
                            A reliable choice for breakfast, meals, or recipes that call for wholesome ingredients.
                        </p>

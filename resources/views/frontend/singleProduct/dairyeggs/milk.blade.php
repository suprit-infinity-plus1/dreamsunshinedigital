...
@section('title','Anaya Dairy | Milk | DreamSunshine Digital')
@section('extracss')
...
@section('content')
    ...
    <div class="whole-body container ">
        <div>
            <p class="mt-3">Home > Anaya Dairy > Milk</p>
        </div>
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['12.png',]; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/anaya-dairy-product/milk/12.png') }}"
                                xoriginal="{{ asset('assets/images/category/anaya-dairy-product/milk/12.png') }}" />
                        </div>
                    </div>
                    ...
                    <div class="d-none d-md-block col-md-2 col-lg-1">
                        @foreach ($images as $img)
                            <div class="col border">
                                <img src="{{ asset('assets/images/category/anaya-dairy-product/milk/' . $img) }}"
                                    data-src="{{ asset('assets/images/category/anaya-dairy-product/milk/' . $img) }}"
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Milk</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Milk – A staple beverage enjoyed for its smooth texture and mild, creamy taste.
                            Perfect for drinking on its own, pairing with breakfast cereals, or using in tea, coffee, and
                            cooking.
                            Suitable for daily use in households, cafes, and kitchens of all kinds.
                            Handled and packed with care to maintain freshness and quality from source to glass.
        ...
        <div class="container">
            ...
            <div class="owl-carousel owl-theme product-carousel" id="dairyEggsSectionCarousel">
                    ...
                    <div class="product-card">
                        <div class="product-card-img position-relative overflow-hidden">
                            ...
                            <div class="card-btn-container w-100 px-3">
                                <a href="{{ route('singleproduct.realeggs') }}" class="btn btn-primary w-100 view-product-btn">View Product</a>
                            </div>
                        </div>
                        <div class="card-body text-center border-top p-3">
                            <h5 class="card-title fxsm-heading fw-bolder mt-1 mb-1">
                                <a href="{{ route('singleproduct.realeggs') }}" class="text-main-color">
                                    Egg
                                </a>
                            </h5>
                ...
                <div class="product_item border rounded-2">
                    <div class="product-card">
                        <div class="product-card-img position-relative overflow-hidden">
                            ...
                            <div class="card-btn-container w-100 px-3">
                                <a href="{{ route('singleproduct.ghee') }}" class="btn btn-primary w-100 view-product-btn">View Product</a>
                            </div>
                        </div>
                        <div class="card-body text-center border-top p-3">
                            <h5 class="card-title fxsm-heading fw-bolder mt-1 mb-1">
                                <a href="{{ route('singleproduct.ghee') }}" class="text-main-color">
                                    Ghee
                                </a>
                            </h5>
                            <ul class="rating_star d-flex align-items-center justify-content-center m-0">
                ...
                <div class="product_item border rounded-2">
                    <div class="product-card">
                        <div class="product-card-img position-relative overflow-hidden">
                            <img src="{!! asset('assets/images/category/anaya-dairy-product/milk/11.png') !!}" alt="" />
                            <div class="product-badge d-flex flex-column align-items-start gap-1">
                                <span class="featured-badge rounded-1 fs-small-heading">Featured</span>
                                <!-- <span class="new-badge rounded-1 fs-small-heading">New</span> -->
                            </div>
                ...
                <div class="product_item border rounded-2">
                    <div class="product-card">
                        ...
                        <div class="card-body text-center border-top p-3">
                            <h5 class="card-title fxsm-heading fw-bolder mt-1 mb-1">
                                <a href="{{ route('singleproduct.paneer') }}"></a>">
                                    Paneer
                                </a>
                            </h5>
                            <ul class="rating_star d-flex align-items-center justify-content-center m-0">

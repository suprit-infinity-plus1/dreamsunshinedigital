...
@section('title','Anaya Dairy |  Tetrapack Milk | DreamSunshine Digital')
@section('extracss')
...
@section('content')
    ...
    <div class="whole-body container ">
        <div>
            <p class="mt-3">Home > Anaya Dairy > Tetrapack Milk</p>
        </div>
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['11.png',]; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/anaya-dairy-product/milk/11.png') }}"
                                xoriginal="{{ asset('assets/images/category/anaya-dairy-product/milk/11.png') }}" />
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Tetrapack Milk</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Tetrapack Milk – Convenient and long-lasting, this milk is sealed in a protective Tetra Pak to
                            ensure freshness and quality.
                            Ideal for busy lifestyles, it stays fresh without refrigeration until opened.
                            Perfect for drinking, cooking, or adding to beverages like coffee and tea.
                            A reliable choice for those seeking quality milk with the convenience of extended shelf life.

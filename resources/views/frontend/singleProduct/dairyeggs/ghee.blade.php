...
@section('title','Anaya Dairy | Ghee | DreamSunshine Digital')
@section('extracss')
...
@section('content')
    ...
    <div class="whole-body container ">
        <div>
            <p class="mt-3">Home > Anaya Dairy > Ghee</p>
        </div>
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['7.png',]; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/anaya-dairy-product/ghee/7.png') }}"
                                xoriginal="{{ asset('assets/images/category/anaya-dairy-product/ghee/7.png') }}" />
                        </div>
                    </div>
                    ...
                    <div class="d-none d-md-block col-md-2 col-lg-1">
                        @foreach ($images as $img)
                            <div class="col border">
                                <img src="{{ asset('assets/images/category/anaya-dairy-product/ghee/' . $img) }}"
                                    data-src="{{ asset('assets/images/category/anaya-dairy-product/ghee/' . $img) }}"
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Pure Cow Ghee</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Cow Ghee – A traditional cooking essential known for its rich aroma and golden texture.
                            Adds depth and flavor to everyday meals, festive dishes, or homemade sweets.
                            Crafted with care to deliver a smooth, velvety consistency and authentic taste.
                            Ideal for cooking, frying, or simply drizzling over warm rice or roti for a comforting finish.

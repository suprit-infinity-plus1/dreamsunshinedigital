...
@section('content')
    ...
    <div class="whole-body container ">
        <div>
            <p class="mt-3">Home > Anaya Dairy > Buffalo Milk</p>
        </div>
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['6.png',]; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/anaya-dairy-product/milk/6.png') }}"
                                xoriginal="{{ asset('assets/images/category/anaya-dairy-product/milk/6.png') }}" />
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Buffalo milk</h4>
                    </div>
   ...
   target="_blank" ><i class="fa-brands fa-facebook-f facebook-icon"></i> </a>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Buffalo Milk – Known for its rich, creamy texture and slightly sweeter taste, this milk is a
                            premium choice for a variety of uses.
                            Perfect for making rich, creamy lassis, desserts, or adding to your daily tea or coffee.
                            Packed with nutrients and higher fat content, making it an indulgent yet wholesome addition to
                            your diet.
                            Sourced with care to ensure freshness and quality in every drop.

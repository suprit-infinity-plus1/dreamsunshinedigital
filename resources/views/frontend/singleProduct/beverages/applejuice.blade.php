...
@section('title','Apple Juice | DreamSunshine Digital')
@section('extracss')
...
@section('content')
    ...
    <div class="whole-body container ">
        <div>
            <p class="mt-3">Home > Apple Juice</p>
        </div>
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['zhakaas-jeera-masala-3.png']; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/zhakaas-jeera-masala/zhakaas-jeera-masala-3.png') }}"
                                xoriginal="{{ asset('assets/images/category/zhakaas-jeera-masala/zhakaas-jeera-masala-3.png') }}" />
                        </div>
                    </div>
                    ...
                    <div class="d-none d-md-block col-md-2 col-lg-1">
                        @foreach ($images as $img)
                            <div class="col border">
                                <img src="{{ asset('assets/images/category/zhakaas-jeera-masala/' . $img) }}"
                                    data-src="{{ asset('assets/images/category/zhakaas-jeera-masala/' . $img) }}"
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Apple juice</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Apple Juice – A naturally refreshing drink with the crisp taste of apples, perfect for any
                            occasion.
                            Enjoy its smooth, fruity flavor as a daily beverage or pair it with meals for added refreshment.
                            Crafted for those who enjoy simple, satisfying fruit juices with a familiar and comforting
                            taste.
                            Ideal for serving at home, on the go, or during gatherings — a timeless choice for all ages.
                        </p>
                ...
                <div class="product_item border rounded-2">
                    <div class="product-card">
                        <div class="product-card-img position-relative overflow-hidden">
                            ...
                            <div class="card-btn-container w-100 px-3">
                                <a href="{{ route('singleproduct.realoxy1') }}"></a>" class="btn btn-primary w-100 view-product-btn">View Product</a>
                            </div>
                        </div>
                        <div class="card-body text-center border-top p-3">
                            <h5 class="card-title fxsm-heading fw-bolder mt-1 mb-1">

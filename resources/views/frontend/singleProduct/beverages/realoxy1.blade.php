    ...
    <div class="whole-body container ">
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['real-oxy-2.png']; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/beverages/water/real-oxy-2.png') }}"
                                xoriginal="{{ asset('assets/images/category/beverages/water/real-oxy-2.png') }}" />
                        </div>
                    </div>

...
@section('content')
    ...
    <div class="whole-body container ">
        <div>
            <p class="mt-3">Home > Beverages > Minipacks</p>
        </div>
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['zhakaas-jeera-masala-5.png']; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/zhakaas-jeera-masala/zhakaas-jeera-masala-5.png') }}"
                                xoriginal="{{ asset('assets/images/category/zhakaas-jeera-masala/zhakaas-jeera-masala-5.png') }}" />
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Mini beverages pack</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Mini Beverage Pack – Mango, Nimbu Pani & Litchi Flavors
                            A fun and flavorful trio of refreshing drinks, perfect for quick sips or on-the-go enjoyment.
                            Each mini pack offers a unique taste experience — the sweet richness of mango, the tangy zest of
                            nimbu pani, and the delicate sweetness of litchi.
                            Great for lunchboxes, travel, parties, or casual sipping anytime. A playful mix of classic
                            favorites in convenient mini sizes.
                        </p>

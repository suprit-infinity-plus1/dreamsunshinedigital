...
@section('title','RealOxy | Real Oxy Mineral Water | DreamSunshine Digital')
@section('extracss')
    ...
    <div class="whole-body container ">
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['real-oxy-3.png']; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/beverages/water/real-oxy-3.png') }}"
                                xoriginal="{{ asset('assets/images/category/beverages/water/real-oxy-3.png') }}" />
                        </div>
                    </div>
                    ...
                    <div class="d-none d-md-block col-md-2 col-lg-1">
                        @foreach ($images as $img)
                            <div class="col border">
                                <img src="{{ asset('assets/images/category/beverages/water/' . $img) }}"
                                    data-src="{{ asset('assets/images/category/beverages/water/' . $img) }}"
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Real Oxy </h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Real Oxy Water – Refreshing, clean, and pure, Real Oxy Water is infused with oxygen to provide a
                            revitalizing drink that hydrates and energizes.
                            Perfect for active individuals, fitness enthusiasts, or anyone looking to stay refreshed
                            throughout the day.
                            Packaged to maintain its freshness and purity, every sip supports hydration while offering a
                            crisp, clean taste.
                            Ideal for recharging after a workout, during busy days, or simply to enjoy a revitalizing burst
                            of hydration.
        ...
        <div class="container">
            ...
            <div class="owl-carousel owl-theme product-carousel" id="dairyEggsSectionCarousel">
                <div class="product_item border rounded-2">
                    <div class="product-card">
                        <div class="product-card-img position-relative overflow-hidden">
                            <img src="{!! asset('assets/images/category/beverages/bebe-apple.png ') !!}" alt="" />
                            ...
                            <div class="card-btn-container w-100 px-3">
                                <a href="{{ route('singleproduct.applejuice') }}" class="btn btn-primary w-100 view-product-btn">View Product</a>
                            </div>
                        </div>
                        <div class="card-body text-center border-top p-3">
                            <h5 class="card-title fxsm-heading fw-bolder mt-1 mb-1">
                                <a href="{{ route('singleproduct.applejuice') }}" class="text-main-color">
                                    Apple Juice
                                </a>
                            </h5>
                ...
                <div class="product_item border rounded-2">
                    <div class="product-card">
                        <div class="product-card-img position-relative overflow-hidden">
                            <img src="{!! asset('assets/images/category/beverages/bebe-orange.png ') !!}" alt="" />
                            <div class="product-badge d-flex flex-column align-items-start gap-1">
                                <!-- <span class="featured-badge rounded-1 fs-small-heading">Featured</span> -->
                                <span class="new-badge rounded-1 fs-small-heading">New</span>
                            </div>
                            <div class="card-btn-container w-100 px-3">
                                <a href="{{ route('singleproduct.orangejuice') }}" class="btn btn-primary w-100 view-product-btn">View Product</a>
                            </div>
                        </div>
                        <div class="card-body text-center border-top p-3">
                            <h5 class="card-title fxsm-heading fw-bolder mt-1 mb-1">
                                <a href="{{ route('singleproduct.orangejuice') }}" class="text-main-color">
                                    Orange Juice
                                </a>
                            </h5>
                            <ul class="rating_star d-flex align-items-center justify-content-center m-0">
                ...
                <div class="product_item border rounded-2">
                    <div class="product-card">
                        <div class="product-card-img position-relative overflow-hidden">
                            <img src="{!! asset('assets/images/category/beverages/zhakas-jeera.png') !!}" alt="" />
                            <div class="product-badge d-flex flex-column align-items-start gap-1">
                                <span class="featured-badge rounded-1 fs-small-heading">Featured</span>
                                <!-- <span class="new-badge rounded-1 fs-small-heading">New</span> -->
                            </div>
                            <div class="card-btn-container w-100 px-3">
                                <a href="{{ (route('singleproduct.jeeramasala')) }}" class="btn btn-primary w-100 view-product-btn">View Product</a>
                            </div>
                        </div>
                        <div class="card-body text-center border-top p-3">
                            <h5 class="card-title fxsm-heading fw-bolder mt-1 mb-1">
                ...
                <div class="product_item border rounded-2">
                    <div class="product-card">
                        <div class="product-card-img position-relative overflow-hidden">
                            ...
                            <div class="card-btn-container w-100 px-3">
                                <a href="{{ (route('singleproduct.realoxy1')) }}" class="btn btn-primary w-100 view-product-btn">View Product</a>
                            </div>
                        </div>
                        <div class="card-body text-center border-top p-3">
                            <h5 class="card-title fxsm-heading fw-bolder mt-1 mb-1">

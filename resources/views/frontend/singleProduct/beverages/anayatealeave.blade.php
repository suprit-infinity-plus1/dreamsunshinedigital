...
@section('title','Anayatea Leaves | DreamSunshine Digital')
@section('extracss')
...
@section('content')
    ...
    <div class="whole-body container ">
        <div>
            <p class="mt-3">Home > Anaya Tea Leave</p>
        </div>
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['tea-leave-img.png',]; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/beverages/tealeaves/tea-leave-img.png') }}"
                                xoriginal="{{ asset('assets/images/category/beverages/tealeaves/tea-leave-img.png') }}" />
                        </div>
                    </div>
                    ...
                    <div class="d-none d-md-block col-md-2 col-lg-1">
                        @foreach ($images as $img)
                            <div class="col border">
                                <img src="{{ asset('assets/images/category/beverages/tealeaves/' . $img) }}"
                                    data-src="{{ asset('assets/images/category/beverages/tealeaves/' . $img) }}"
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Anaya Tea Leaves</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Anaya Tea Leaves – A thoughtfully selected blend crafted for a rich and balanced tea experience.
                            Known for its deep aroma and smooth taste, it brews a comforting cup perfect for mornings or
                            relaxed evenings.
                            Ideal for those who appreciate traditional tea with consistent flavor and quality.
                            Carefully packed to preserve freshness, making every cup a satisfying ritual.
                        </p>

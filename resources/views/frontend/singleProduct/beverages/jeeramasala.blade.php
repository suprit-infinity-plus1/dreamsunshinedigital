...
@section('title','Zhakaas Jeera Masala | DreamSunshine Digital')
@section('extracss')
    ...
    <div class="whole-body container ">
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['zhakaas-jeera-masala-4.png']; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/zhakaas-jeera-masala/zhakaas-jeera-masala-4.png') }}"
                                xoriginal="{{ asset('assets/images/category/zhakaas-jeera-masala/zhakaas-jeera-masala-4.png') }}" />
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Jeera Masala</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Jeera Masala – A spiced, tangy refreshment inspired by traditional flavors.
                            Combining the distinctive taste of cumin with a savoury twist, this drink offers a bold and
                            invigorating experience.
                            Perfect as a cooling beverage with meals or on its own for a burst of spice and refreshment.
                            A popular choice for those who enjoy authentic, flavorful drinks with a desi touch.

...
@section('title','Orange Juice | DreamSunshine Digital')
@section('extracss')
...
@section('content')
    ...
    <div class="whole-body container ">
        <div>
            <p class="mt-3">Home > Orange Juice</p>
        </div>
        ...
        <div class="container">
            <div class="row g-0 d-flex flex-column flex-sm-row justify-content-center ">
                @php
                    $images = ['zhakaas-jeera-masala-2.png']; // replace with your dynamic image array
                @endphp
                {{-- Left Column --}}
                    ...
                    <div class="border  ">
                        <div class="xzoom-container ms-auto me-auto " style="">
                            <img class="xzoom single-product-card-img " id="xzoom-default"
                                src="{{ asset('assets/images/category/zhakaas-jeera-masala/zhakaas-jeera-masala-2.png') }}"
                                xoriginal="{{ asset('assets/images/category/zhakaas-jeera-masala/zhakaas-jeera-masala-2.png') }}" />
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-lg-6 order-sm-3 ps-md-4">
                    <div class="text-black mt-4">
                        <h4 class="fw-bold anaya-title text-main-color">Orange juice</h4>
                    </div>
                    ...
                    <div class="mt-4 ">
                        ...
                        <p id="descriptionText" class="description-text">
                            Orange Juice – A bright and refreshing drink with the naturally zesty flavor of oranges.
                            Enjoy its smooth, citrusy taste as a satisfying companion to breakfast or a cooling sip any time
                            of day.
                            Loved for its familiar, fruity profile that suits all ages and occasions.
                            Whether served chilled at home or packed on the go, it's a timeless favorite.

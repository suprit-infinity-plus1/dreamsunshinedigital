...
@section('title','Soft Drinks | DreamSunshine Digital')
@section('extracss')
...
@section('content')
    ...
    <div class="category-main mb-5">
        ...
        <div class="category-banner">
            ...
            <h4 class="category-banner-title">Home > Soft Drinks</h4>
            ...
            <div class="category-card">
                ...
                <div class="category-card-body">
                    <a href="{{ route("singleproduct.applejuice") }}">
                        <h5 class="category-card-title fw-bolder">Apple juice</h5>
                    </a>
                    <span>
                    ...
                    <div class="text-center position-relative card-btn-container">
                        <a href="{{ route("singleproduct.applejuice") }}"
                            class="text-center position-relative btn btn-primary view-product-btn">View
                            Product</a>
                    </div>
                </div>
            </div>
            <div class="category-card">
                ...
                <div class="category-card-body">
                    <a href="{{ route("singleproduct.orangejuice") }}">
                        <h5 class="category-card-title fw-bolder">Orange juice</h5>
                    </a>
                    <span>
                        <i class="fa-solid fa-star" style="color: #FFD700; font-size: 16px;"></i>
                        <i class="fa-solid fa-star" style="color: #FFD700; font-size: 16px;"></i>
            ...
            <div class="category-card">
                ...
                <div class="category-card-body">
                    <a href="{{ route("singleproduct.jeeramasala") }}">
                        <h5 class="category-card-title fw-bolder">Zhakas jeera</h5>
                    </a>
                    <span>
                        <i class="fa-solid fa-star" style="color: #FFD700; font-size: 16px;"></i>
                        <i class="fa-solid fa-star" style="color: #FFD700; font-size: 16px;"></i>

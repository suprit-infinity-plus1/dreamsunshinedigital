...
@section('title','Food & Grocery | DreamSunshine Digital')
@section('extracss')
        ...
        <div class="category-container">
            <div class="category-card">
                ...
                <div class="category-card-body">
                    <a href="{{ route("singleproduct.rice") }}"><h5  class="category-card-title fw-bolder">Rice sack</h5></a>
                    <span>
                    ...
                    <div class="text-center position-relative card-btn-container">
                        <a href="{{ route("singleproduct.rice") }}" class="text-center position-relative btn btn-primary view-product-btn">View
                            Product</a>
                    </div>
                </div>
            </div>
            <div class="category-card">
                <div class="category-img-container">
                    <img class="category-card-image" src="{{ asset('assets/images/category/foodGroceryImages/rice-container.png') }}" class="card-img-top"
                        alt="Category Image" />
                </div>

                <div class="category-card-body">
                <a href="{{ route("singleproduct.rice") }}"><h5  class="category-card-title fw-bolder">Rice Container</h5></a>
                <span>
                        <i class="fa-solid fa-star" style="color: #FFD700; font-size: 16px;"></i>
                        <i class="fa-solid fa-star" style="color: #FFD700; font-size: 16px;"></i>
                        <i class="fa-solid fa-star" style="color: #FFD700; font-size: 16px;"></i>
                    ...
                    <div class="text-center position-relative card-btn-container">
                        <a href="{{ route("singleproduct.rice") }}"  class="position-relative btn btn-primary view-product-btn">View
                            Product</a>
                    </div>
                </div>
            </div>
            ...
            <div class="category-card">
                ...
                <div class="category-card-body">
                    <a href="{{ route("singleproduct.dreamsugar") }}"  ><h5 class="category-card-title fw-bolder">Dream Sugar</h5></a>
                    <span>
                        <i class="fa-solid fa-star" style="color: #FFD700; font-size: 16px;"></i>
                        <i class="fa-solid fa-star" style="color: #FFD700; font-size: 16px;"></i>
                        <i class="fa-solid fa-star" style="color: #FFD700; font-size: 16px;"></i>
                    ...
                    <div class="text-center position-relative card-btn-container">
                        <a href="{{ route("singleproduct.dreamsugar") }}"  class="position-relative btn btn-primary view-product-btn">View
                            Product</a>
                    </div>
                </div>
            </div>
            ...
            <div class="category-card">
                ...
                <div class="category-card-body">
                    <a href="{{ route("singleproduct.anayatealeave") }}"><h5 class="category-card-title fw-bolder">Anaya Tea leaves</h5></a>
                    <span>
                        <i class="fa-solid fa-star" style="color: #FFD700; font-size: 16px;"></i>
                        <i class="fa-solid fa-star" style="color: #FFD700; font-size: 16px;"></i>
                        <i class="fa-solid fa-star" style="color: #FFD700; font-size: 16px;"></i>
                    ...
                    <div class="text-center position-relative card-btn-container">
                        <a href="{{ route("singleproduct.anayatealeave") }}" class="position-relative btn btn-primary view-product-btn">View
                            Product</a>
                    </div>
                </div>
            </div>

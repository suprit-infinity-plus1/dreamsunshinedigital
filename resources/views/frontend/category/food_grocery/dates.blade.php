...
@section('title','Dates | DreamSunshine Digital')
@section('extracss')
...
@section('content')
    ...
    <div class="category-main mb-5">
        ...
        <div class="category-banner">
            ...
            <h4 class="category-banner-title">Home > Dates</h4>
            ...
            <div class="category-card">
                ...
                <div class="category-card-body">
                    ...
                    <div class="text-center position-relative card-btn-container">
                        <a href="{{ route("singleproduct.dates") }}"class="position-relative btn btn-primary view-product-btn">View
                            Product</a>
                    </div>
                </div>
            </div>

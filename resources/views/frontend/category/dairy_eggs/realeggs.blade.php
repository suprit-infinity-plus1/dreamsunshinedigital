...
@section('title','Real Eggs | DreamSunshine Digital')
@section('extracss')
        ...
        <div class="category-container">
            ...
            <div class="category-card">
                <div class="category-img-container">
                                       <a href="{{ route("singleproduct.realeggs") }}"><img src="{{ asset('assets/images/category/real-eggs/real-eggs-2.png') }}" class="card-img-top"
                        alt="Category Image"></a>
                </div>

                <div class="category-card-body">
                   <a href="{{ route("singleproduct.realeggs") }}"> <h5 class="category-card-title fw-bolder">Eggs</h5></a>
                    <span>
                    ...
                    <div class="text-center position-relative card-btn-container">
                        <a href="{{ route("singleproduct.realeggs") }}" class="position-relative btn btn-primary view-product-btn">View
                            Product</a>
                    </div>
                </div>
            </div>
